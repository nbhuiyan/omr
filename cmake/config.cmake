...
if(NOT OMR_COMPILER)
	if(OMR_JITBUILDER)
		...
		if(OMR_LLJB)
			message(FATAL_ERROR "OMR_LLJB is enabled but OMR_COMILER and OMR_JITBUILDER are not enabled")
		endif()
	endif()
	...
	if(OMR_LLJB)
		message(FATAL_ERROR "OMR_LLJB is enabled but OMR_COMPILER is not enabled")
	endif()
endif()
