...
OMR::CodeCacheManager::destroy()
   ...
   if (_elfExecutableGenerator)
      ...
      if (numCharsWritten > 0 && numCharsWritten < maxElfFilenameSize)
         {
         _elfExecutableGenerator->emitELF((const char*) &elfFilename, 
...
TR::CodeCacheSymbolContainer * OMR::CodeCacheManager::_relocatableSymbolContainer = NULL;
TR::CodeCacheRelocationInfoContainer * OMR::CodeCacheManager::_relocations = NULL;
...
OMR::CodeCacheManager::initializeRelocatableELFGenerator(void)
   ...
   TR::CodeCacheRelocationInfoContainer * _relocations = static_cast<TR::CodeCacheRelocationInfoContainer *>(self()->getMemory(sizeof(TR::CodeCacheRelocationInfoContainer)));
   _relocations->_head = NULL;
   _relocations->_tail = NULL;
   _relocations->_numRelocations = 0;
   //TR::ELFRelocatableGenerator * OMR::CodeCacheManager::_elfRelocatableGenerator = NULL;
...
void
OMR::CodeCacheManager::initializeELFGenerator(void)
   {
   TR::CodeCacheSymbolContainer * symbolContainer = static_cast<TR::CodeCacheSymbolContainer *>(self()->getMemory(sizeof(TR::CodeCacheSymbolContainer)));
   ...
   //TR::ELFExecutableGenerator * OMR::CodeCacheManager::_elfExecutableGenerator = NULL;
