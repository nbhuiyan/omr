...
protected:
   ...
   */
    ...
    * @return
   */
   void initializeELFGenerator(void);
   ...
   static TR::CodeCacheSymbolContainer   *_relocatableSymbolContainer; /**< Symbol container used for tracking CodeCacheSymbols, for the purpose of writing to relocatable ELF object file */
   static TR::CodeCacheRelocationInfoContainer *_relocations; /**< for tracking relocation info */
